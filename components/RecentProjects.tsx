...
const RecentProjects = () => {
  return (
    <div className="py-20 " id="projects">
      ...
      <div className="flex lg:w-full flex-wrap items-center justify-center p-4 lg:gap-10 gap-16 mt-10  ">
        {projects.map((item) => (
          <div
            className="lg:min-h-[32.5rem] h-[25rem]  flex-1 flex items-center justify-center sm:w-96 w-[80vw] "
            key={item.id}
          >
